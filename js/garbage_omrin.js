    ...
    if (service == 'omrin') {
        var config = {
            "2017": {
                "Sortibak": {
                    "title": "Sortibak",
                    "description": "Op de aangegeven data wordt de Sortibak geleegd. Deze dient die dag om 7.30 uur aan de weg te staan.",
                ...
                "Biobak": {
                    "title": "Biobak",
                    "description": "Op de aangegeven data wordt de Biobak geleegd. Deze dient op die dag om 7.30 uur aan de weg te staan.",
                    "additional_description": "",
                    "img_class": "BIO",
                    "dates": {
                        "1": ["12"],
                ...
                "Oud papier en karton": {
                    "title": "Oud papier en karton",
                    "description": "Op de aangegeven data wordt oud papier opgehaald. Het papier of de papier container op werkdagen om 17.00 uur aanbieden aan de weg. Op zaterdagen om 8.30 uur.",
                    "additional_description": "",
                    "img_class": "PAP",
                    "dates": {
                        "1": ["09"],
        ...
        for(var d in config['2017']){
            curr = capitalizeFirstLetter(d.toLowerCase());
            if (typeof(returnDates[curr]) == 'undefined') {
                returnDates[curr] = {}
            }
            for(var date in config['2017'][d].dates){
                config['2017'][d].dates[date].forEach(function(value){
                    var testDate = moment('2017-' + date + '-' + value);
                    if (testDate.isBetween(startDate, endDate, 'days', true)) {
